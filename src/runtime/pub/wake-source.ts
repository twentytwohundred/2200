...
function composeTaskBody(args: {
  ...
  return [
    ...
    ``,
    `Someone in the pub is addressing you. Default behaviour is to respond.`,
    ``,
    `1. Call \`pub.read\` to fetch the latest context.`,
    `2. Call \`pub.send\` with your reply. This is the ONLY way the sender will`,
    `   see what you have to say... your final-answer text is not delivered to`,
    `   the pub. If you skip \`pub.send\` you are silent.`,
    ``,
    `Example reply:`,
    ``,
    '```tool',
