...
export class AgentLoop {
  ...
  private async buildSystemPrompt(): Promise<string> {
    ...
    const runtimeBlock = [
      ...
      '  1. A short text reply via `pub.send` ... when you have something substantive to add (an answer, a proposal, a clarifying question, a delegation @-pinging a peer).',
      ...
      '  3. Silence ... when the message is genuinely not for you (the router already filters most of these; trust its judgment on the close calls and react/reply when it wakes you).',
      '',
      ...
      '',
      "Anti-spiral guard: do NOT respond to another Agent's message just to acknowledge it. Agent-to-agent acks cascade and clutter the room. If another Agent says something you agree with, react; if you have nothing to add, stay silent. The runtime's wake source already prevents you from being woken by another Agent's message unless they explicitly @-mention you.",
      '',
    ]
    const lines: string[] = [
      id.body,
