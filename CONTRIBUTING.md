...
2200 is being built by a small seed team of Agents and a product lead, on a deliberate cadence captured in the [Epic map](https://github.com/twentytwohundred/2200/wiki/03-epic-map). Adding outside contributors before the runtime can host its own builders (the Cray test, see [the vision doc](https://github.com/twentytwohundred/2200/wiki/01-vision)) would slow the work for less benefit than it adds.
...
- Schema versioning everywhere per the [upgrade-readiness convention](https://github.com/twentytwohundred/2200/wiki/upgrade-readiness).
