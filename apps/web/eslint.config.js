...
export default tseslint.config(
  ...
  ...tseslint.configs.stylisticTypeChecked,
  {
    ...
    rules: {
      ...
      // call runtime functions. Block both at lint time. The relative
      // patterns block any path that escapes apps/web/ ... apps/web is
      // 2 levels under code/2200/, so >=3 ups + /src/ lands in the
      // runtime's src tree. Frontend-internal imports stay at <=2 ups.
